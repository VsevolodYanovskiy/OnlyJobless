...
При запуске сервиса пользователь видит окно регистрации, указывает имя/логин, пароль и предпочитаемый язык интерфейса и взаимодействия с LLM после чего завершает регистрацию или может выбрать опцию "Already have an account" и авторизоваться. Далее он видит интерфейс сервиса и боковую панель со списком сохранённых чатов. По кнопке начать новый чат в и ему предлагается ввести название должности на которую он хочет пройти собеседование. После выбора он переходит в диалоговое окно, где видит приветствие от LLM и первый вопрос. 
