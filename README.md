...
## Задачи участников:
1. TL: Яновский Всеволод. Задачи: Реализация взаимодействия с БД. Ревью кода участников. "Косметические" паравки кода участников. Срок выполнения 3-4 дней.

2. DEV1: Густов Ян. Задачи: Backend(взаимодействие с LLM через api). Срок выполнения 2-3 дня.

3. DEV2: Мохамед Али. Задачи: Фронт(смотреть раздел что видит пользователь). Срок выполнения 5 дней.

4. DEV3: Моргоев Амиран. Задачи: Покрытие тестами не менее 95%.(не менее 2х скриптовых собеседований + тестирование функционала). Срок выполнения 3-4 дня.
