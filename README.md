...
Что насчет безопасности? Команда OnlyJobless заботится о безопасности ваших персональных данных. Все ваши пароли будут хранится хешами, а номер телефона, email и юзернейм в зашифрованом виде, ключ будет безопасно лежать невидимым для всего остального мира, такчто даже если злоумышленники получат доступ к нашей БД, то вы можете не переживвать о раскрытии выших данных, все что они получат это абсолютно бесполезный набор данных и доступ к вашим аккаунтам они не получат.

Какие модели доступны? К сожалению, команда OnlyJobless оправдывает название нашего проекта и мы все являемся безработными студентами, поэтому не можем предоставить вам доступ к продвинутым платным моделям. Мы будем использовать следующие бесплатные ллм:
1. Qwen
2. Deepseek
