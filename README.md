...
Конечно да, это же сохраняется в истории чата, а при выставлении оценки мы попросим модель анализировать весь чат, и конечно дадим ей указание снижать оценку.
