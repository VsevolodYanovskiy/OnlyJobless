...
К сожалению, команда OnlyJobless оправдывает название нашего проекта, и мы все являемся безработными студентами, поэтому не можем предоставить вам доступ к продвинутым платным моделям, таким как ChatGPT, Claude или Gemini. Мы будем использовать следующие бесплатные ллм:
1. Qwen
2. Deepseek
